...
<span style='font-size:15px;'>Ini adalah Sistem Analisis Sentimen Pengunjung Hotel Bahasa Indonesia yang dikembangkan sebagai bagian dari penelitian tugas akhir yang bertujuan untuk mengidentifikasi dan mengklasifikasikan opini pengunjung hotel berdasarkan ulasan teks dari berbagai platform digital.</span></p>            
