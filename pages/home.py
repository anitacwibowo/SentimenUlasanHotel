...
<span style='font-size:15px;'>Ini adalah <strong style='font-size:16px;'>Sistem Analisis Sentimen Pengunjung Hotel Bahasa Indonesia</strong> yang dikembangkan sebagai bagian dari penelitian tugas akhir yang bertujuan untuk mengidentifikasi dan mengklasifikasikan opini pengunjung hotel berdasarkan ulasan teks dari berbagai platform digital.</span></p>            
